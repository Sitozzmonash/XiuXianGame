...
export const REALMS: RealmDef[] = [
  ...
  },
  {
    ...
    stages: [
      ...
      { id: 'fd_full', label: '筑基圆满', cultivationMax: 3400000 },
    ],
  },
  {
    id: 'core_formation',
    ...
    stages: [
      ...
      { id: 'cf_full', label: '结丹圆满', cultivationMax: 34000000 },
    ],
  },
  {
    id: 'nascent_soul',
    ...
    stages: [
      ...
      { id: 'ns_full', label: '元婴圆满', cultivationMax: 340000000 },
    ],
  },
  {
    id: 'spirit_transform',
    ...
    stages: [
      ...
      { id: 'st_full', label: '化神圆满', cultivationMax: 3.4e9 },
    ],
  },
  {
    id: 'void_refining',
    ...
    stages: [
      ...
      { id: 'vr_full', label: '炼虚圆满', cultivationMax: 3.4e10 },
    ],
  },
  {
    id: 'body_integration',
    ...
    stages: [
      ...
      { id: 'bi_full', label: '合体圆满', cultivationMax: 3.4e11 },
    ],
  },
  {
    id: 'great_vehicle',
    ...
    stages: [
      ...
      { id: 'gv_full', label: '大乘圆满', cultivationMax: 3.4e12 },
    ],
  },
  {
    id: 'tribulation',
    ...
    stages: [
      ...
      { id: 'tb_full', label: '九劫圆满', cultivationMax: 3.4e13 },
    ],
  },
  {
    id: 'ascension',
